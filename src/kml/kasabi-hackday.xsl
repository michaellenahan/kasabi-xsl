...
<xsl:stylesheet 
	...
	<xsl:template match="sparql:result">
      ...
      <description><img src=\"<xsl:value-of select="sparql:binding[@name='thumbnail_url']/sparql:uri"/>\"/><xsl:value-of select="sparql:binding[@name='description']/sparql:literal"/></description>
	    <Point>
	    	<coordinates>
